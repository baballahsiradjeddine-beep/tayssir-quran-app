    ...
    protected function getStats(): array
    {
        ...
        return [
            ...
            Stat::make(
                ...
                new \Illuminate\Support\HtmlString('<div class="text-base font-medium whitespace-normal leading-snug">' . ($signupsDisplay ?: 'لا توجد بيانات') . '</div>')
            )
            ...
            Stat::make(
                ...
                new \Illuminate\Support\HtmlString('<div class="text-base font-medium whitespace-normal leading-snug">' . $stats['top_referrer']['code'] . ' = ' . $stats['top_referrer']['count'] . ' ' . __('stats.growth.students_label') . '</div>')
            )
