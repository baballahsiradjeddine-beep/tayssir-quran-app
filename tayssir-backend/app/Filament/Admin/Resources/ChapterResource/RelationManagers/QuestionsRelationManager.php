                                        ...
                                        Forms\Components\Group::make()
                                            ->schema([
                                                ...
                                                Forms\Components\Toggle::make('is_latex')
                                                    ->label("استخدام رموز التجويد (Latex)")
                                                    ->inline(false)
                                                    ->columnSpan(2)
                                                    ->default(false),
                                            ])
