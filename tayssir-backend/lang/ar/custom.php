...
return [
    ...
    'nav.section.quran' => 'إدارة المصحف الشريف',
    'nav.section.applications' => 'التطبيقات',

    'models.cards' => 'البطاقات (قديم)',
    'models.card' => 'بطاقة',

    'models.divisions' => 'مسارات الحفظ / الروايات',
    'models.division' => 'مسار الحفظ / الرواية',

    'models.materials' => 'المواد والبرامج التعليمية',
    'models.material' => 'مادة / برنامج',

    'models.units' => 'المحاور والوحدات',
    'models.unit' => 'محور / وحدة',

    'models.chapters' => 'الدروس والفصول',
    'models.chapter' => 'درس / فصل',
    ...
    'models.promoter.wilaya' => 'المنطقة',
    'models.promoter.wilayas' => 'المناطق',
    'models.promoter.wilaya.empty' => 'لم يتم اختيار المنطقة',
    'models.promoter.wilaya.field' => 'arabic_name',
    'models.promoter.commune' => 'المدينة/المحافظة',
    'models.promoter.communes' => 'المدن والمحافظات',
    'models.promoter.commune.empty' => 'لم يتم اختيار المدينة/المحافظة',
    ...
    'models.promoCode.student_discount' => 'تخفيض الحافظ (%)',
    ...
    'forms.promoCode.helper.student_discount' => 'نسبة تخفيض للحفاظ (0-100%)',
    ...
    'models.user.wilaya' => 'المنطقة',
    'models.user.wilayas' => 'المناطق',
    'models.user.wilaya.empty' => 'لم يتم اختيار المنطقة',
    'models.user.commune' => 'المدينة/المحافظة',
    'models.user.commune.empty' => 'لم يتم اختيار المدينة/المحافظة',
    'models.user.wilaya.field' => 'arabic_name',
    'models.user.commune.field' => 'arabic_name',

    'models.user.tabs.all' => 'الكل',
    'models.user.tabs.students' => 'الحفاظ',
    ...
    // # Bayan AI Settings
    'settings.tito.title' => 'مساعد رفيق بيان الذكي',
    'settings.tito.section.information' => 'إعدادات المساعد الذكي',
    'settings.tito.active' => 'تفعيل رفيق بيان',
    'settings.tito.persona' => 'شخصية رفيق بيان (التعليمات والبيانات)',
    ...
    'settings.tito.subscription_price' => 'سعر الوقف',
    'settings.tito.available_materials' => 'السور والمواد المتاحة',
    'settings.tito.social_links' => 'روابط ومواقع التواصل',
    'settings.tito.strict_mode' => 'منع الأسئلة خارج نطاق علوم القرآن',
    'settings.tito.strict_mode_hint' => 'تفعيل هذا الخيار سيجعل رفيق بيان يرفض الإجابة عن أي سؤال خارج نطاق القرآن وعلومه.',
    ...
    'models.countries' => 'الدول',
    'models.country' => 'الدولة',
    'models.country.name' => 'اسم الدولة',
    'models.country.code' => 'رمز الدولة',
    'models.country.phone_code' => 'رمز الهاتف',

    'models.regions' => 'المناطق/الولايات',
    'models.region' => 'المنطقة/الولاية',
    'models.region.name' => 'اسم المنطقة',

    'models.user.country' => 'الدولة',
    'models.user.region' => 'المنطقة',
];
