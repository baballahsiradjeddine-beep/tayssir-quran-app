...
Route::prefix('v1')->group(function () {
    ...
    // Public Landing Page Fast Endpoints
    Route::prefix('landing')->group(function () {
        Route::get('stats', [LandingController::class, 'stats'])
            ->summary('Get landing stats')
            ->description('Returns total users and active now users for public landing page UI');
            
        Route::get('leaderboard', [LandingController::class, 'leaderboard'])
            ->summary('Get landing leaderboard')
            ->description('Returns top 3 users strictly for public landing page UI');

        Route::get('subjects', [LandingController::class, 'subjects'])
            ->summary('Get landing subjects')
            ->description('Returns all active materials (subjects) with images and info');

        Route::get('tools', [LandingController::class, 'tools'])
            ->summary('Get landing tools')
            ->description('Returns all available app tools with images and info');
    });
});
